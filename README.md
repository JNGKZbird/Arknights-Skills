...
除单人干员包外，本库另有两类**试验性拓展包**（均为**预览版**，格式与平衡性仍在打磨，欢迎试用反馈）——**双向角色扮演包**与**话剧包**：
...
> **预览版说明**：拓展包为试验产物，正式化前格式与内容可能调整。规模提示：双向角色扮演包 full ≈ 6.1k~7.1k tokens（含用户侧手册，比单人包大）、compact ≈ 400~420；话剧包 full ≈ 7.2k、compact ≈ 400。
